...
const Login = () => {
  ...
  return (<div>
    ...
    <h1>New User ?</h1>
    <button type="button" class="btn btn-primary" style={{display: 'block', marginLeft: 'auto', marginRight: 'auto', marginTop: '20px'}}>
      <NavLink className="nav-link" to="/register" style={{color: 'white', textAlign: 'center', marginLeft: 'auto', marginRight: 'auto'}}>Register</NavLink>
      </button>
    </div>
